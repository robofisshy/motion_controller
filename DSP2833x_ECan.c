...
/* Configure bit timing parameters for eCANA*/
    ...
    ECanaShadow.CANMC.all = ECanaRegs.CANMC.all;
	ECanaShadow.CANMC.bit.CCR = 0 ;            // Set CCR = 0，CANBTC配置为允许值之后才允许该操作
    ECanaRegs.CANMC.all = ECanaShadow.CANMC.all;
...
/*    ****Set interrupt******/
/*
    ECanaShadow.CANMIM.all=ECanaRegs.CANMIM.all;//Set interrupt box25
    ECanaShadow.CANMIM.bit.MIM25=1;
	ECanaRegs.CANMIM.all=ECanaShadow.CANMIM.all;
	ECanaShadow.CANGIM.all=ECanaRegs.CANGIM.all;//Set Global interrupt
...
/* Configure bit timing parameters for eCANB*/
    ...
    /*****Set interrupt*******/
    ECanbShadow.CANMIM.all=ECanbRegs.CANMIM.all;//Set interrupt box25
    ECanbShadow.CANMIM.bit.MIM25=1;
	ECanbRegs.CANMIM.all=ECanbShadow.CANMIM.all;
	ECanbShadow.CANGIM.all=ECanbRegs.CANGIM.all;//Set Global interrupt
